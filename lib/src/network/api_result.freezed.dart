...
class _$ApiResultTearOff {
  ...
  Failure<T> failure<T>({required NetworkExceptions error, String? message}) {
    return Failure<T>(
      error: error,
      message: message,
    );
...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions error, String? message) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(NetworkExceptions error, String? message)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $FailureCopyWith<T, $Res> {
  ...
  $Res call({NetworkExceptions error, String? message});
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure({required NetworkExceptions error, String? message}) =
      _$Failure<T>;
